...
- Ejecutar el comando de establecer 30GB de ram para la gpu en macos (sudo sysctl iogpu.wired_limit_mb=30720)
- Ejecutar el modelo (OMLX_PREFILL_MIN_CHUNK_TOKENS=512 omlx serve --host 0.0.0.0 --port 8080 --initial-cache-blocks 35)
...
```bash
omlx serve --host 0.0.0.0 --port 8080 --initial-cache-blocks 35
