...
- Ejecutar el comando de establecer 30.4GB de ram para la gpu en macos (sudo sysctl iogpu.wired_limit_mb=31129)
- Ejecutar el modelo (OMLX_MAX_CACHE_SIZE=8GB OMLX_MAX_MODEL_LEN=100000 omlx serve --host 0.0.0.0 --port 8080 --initial-cache-blocks 35)
...
```bash
OMLX_MAX_CACHE_SIZE=8GB OMLX_MAX_MODEL_LEN=100000 omlx serve --host 0.0.0.0 --port 8080 --initial-cache-blocks 35
